          ...
          <div class="modal-body">
            <form data-parsley-validate class="form-horizontal form-label-left" role="form">
              <div class="form-group">
                ...
                <div class="col-md-7">
                  <input id="edit-user-name" type="text" class="form-control" name="name" required="required"
                                               :value="edit_user_data.name"  @input="update('name', $event)"
                                               />
              ...
              <div class="form-group">
                ...
                <div class="col-md-7">
                  <input id="edit-user-email" type="text" class="form-control" name="email" required="required"
                                               :value="edit_user_data.email" @input="update('email', $event)"
                                               />
...
export default {
  ...
  methods : {
    ...
    submit() {
      this.$http.put('/api/users/' + this.edit_user_data.id, this.edit_user_data)
        .then( (response) => {
